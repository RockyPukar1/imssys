              ...
              <div className="rounded px-8 pt-6 pb-8 mb-4">
                <form className="bg-white mb-6">
                  <div className="mb-4">
                    ...
                    <input className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none" id="username" type="text" placeholder="Enter you name" />
                  </div>
                  <div className="mb-4">
                    <label className="block text-gray-700 text-sm mb-2 text-left" htmlFor="username">
                      Email*
                  ...
                  <div className="mb-4">
                    ...
                    <input className="appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none" id="password" type="password" placeholder="Enter you password" />
                  </div>
                ...
                <button className="w-full text-grey-50 bg-primary-600 text-center mb-4 rounded-md p-2">Get Started</button>
                <button className="w-full text-center mb-4 rounded-md flex gap-3 items-center justify-center p-3 border"><SocialIcon /> <span>Sign up with Google</span></button>
                <p className="text-center text-gray-500 text-xs">
                  Already have an account? <span className="text-primary-600">Log up</span>
                </p>
              </div>
            </div>
          </div>
